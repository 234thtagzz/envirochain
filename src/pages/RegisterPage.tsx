...
import { Leaf, Mail, Lock, User, Building, Eye, EyeOff, Radio, Brain, ShieldCheck } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 w-full rounded-xl shadow-2xl overflow-hidden">
      ...
      <div className="flex w-full flex-col justify-center px-6 py-12 sm:px-12 lg:w-1/2 lg:px-16 xl:px-20">
        <div className="mx-auto w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <label className="flex items-start gap-2.5">
              ...
              <span className="text-sm text-gray-500">
                I agree to the{' '}
                <span className="font-medium text-emerald-600 cursor-pointer">Terms of Service</span>{' '}
                and{' '}
                <span className="font-medium text-emerald-600 cursor-pointer">Privacy Policy</span>
              </span>
            </label>
            ...
            <button
              type="submit"
              disabled={!agreed}
              className="w-full rounded-lg bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
            >
              Create Account
            </button>
          </form>
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            ...
            <Link to="/login" className="font-medium text-emerald-600 transition hover:text-emerald-700">
              Sign in
            </Link>
          </p>
        </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center bg-emerald-800 p-16">
        <div className="max-w-md text-center">
          ...
          <p className="mt-4 text-emerald-100/80">
            Create an account to access real-time monitoring, blockchain-verified data, and AI-powered
